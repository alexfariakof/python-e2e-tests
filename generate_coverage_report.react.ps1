...
py -m pytest --env=local __tests__/.frontend_react --browser chromium --junitxml=./coverage/frontend_react_reporter.xml --html=./coverage/frontend_react_index.html
...
if ($latestDir -ne $null) {
    ...
    Invoke-Item $reportPath\frontend_react_index.html
}
else {
